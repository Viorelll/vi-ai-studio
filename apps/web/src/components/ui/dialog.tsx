...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-6.5 -mb-6.5 flex flex-col-reverse gap-2 rounded-b-[14px] border-t bg-muted/50 p-6.5 sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    >
